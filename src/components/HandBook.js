      ...
      <div className="container page displayhandbook">
        ...
        <div>
          ...
          <p>
            ...
            related to the subjects. If you want to add theory lectures, e.g
            Physics, then select ‘Add Theory Subject’ radio button and click
            ‘Add’ button. After submitting the values the input fields will be reset
            and you need to add another subject in the same way.
          </p>
        </div>
